...
Alias: $CSKontaktart = http://fhir.de/CodeSystem/kontaktart-de
Alias: $VSKontaktart = http://fhir.de/ValueSet/kontaktart-de
Alias: $CSFachabteilungsschluessel = http://fhir.de/CodeSystem/dkgev/Fachabteilungsschluessel
Alias: $VSFachabteilungsschluessel = http://fhir.de/ValueSet/dkgev/Fachabteilungsschluessel
Alias: $CSFachabteilungsschluesselErweitert = http://fhir.de/CodeSystem/dkgev/Fachabteilungsschluessel-erweitert
