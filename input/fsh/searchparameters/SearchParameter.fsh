...
//
// Composite SearchParameter needs to be fixed
//
...
//* component[=].expression = "extension('http://fhir.de/StructureDefinition/Entlassungsgrund').extension('ErsteUndZweiteStelle').value.ofType(Coding)"
...
//* component[=].expression = "extension('http://fhir.de/StructureDefinition/Entlassungsgrund').extension('DritteStelle').value.ofType(Coding)"
